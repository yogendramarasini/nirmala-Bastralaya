        ...
        <div className="grid lg:grid-cols-3 gap-12">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-end justify-between mt-auto">
                        ...
                        <div className="text-right">
                          ...
                          {item.salePrice && (
                            <p className="text-xs text-gray-400">{formatPrice(itemPrice)} each</p>
                          )}
                        </div>
                      </div>
                    </div>
          ...
          <div className="lg:col-span-1">
            <div className="border border-gray-100 rounded-lg p-6 sticky top-24">
              ...
              <Link
                href="/checkout"
                className="btn-primary w-full mt-6 py-4 text-sm flex items-center justify-center gap-2"
              >
                Proceed to Checkout
                <ArrowRight size={16} />
              </Link>
              ...
              <Link
                href="/shop"
                className="block text-center text-sm text-gray-400 hover:text-primary transition-colors mt-4"
              >
                Continue Shopping
              </Link>
            </div>
